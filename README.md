...
[![Version](https://img.shields.io/badge/version-1.0.8-blue.svg)][releases]
...
**Debian/Ubuntu (.deb):**
```bash
sudo dpkg -i hablara_1.0.8_amd64.deb
sudo apt-get install -f  # Falls Abhängigkeiten fehlen
```

**Fedora/RHEL (.rpm):**
```bash
sudo rpm -i hablara-1.0.8-1.x86_64.rpm
# oder: sudo dnf install hablara-1.0.8-1.x86_64.rpm
```

**AppImage (Universal, keine Installation nötig):**
```bash
chmod +x hablara_1.0.8_amd64.AppImage
./hablara_1.0.8_amd64.AppImage
```
...
**Autor:** Marc Allgeier | **Version:** 1.0.8
