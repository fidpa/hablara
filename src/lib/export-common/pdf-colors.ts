/**
 * PDF Color Palette & Configuration
 *
 * Centralized color definitions and configuration for PDF generation with jsPDF.
 * Shared between recording and chat PDF exports.
 *
 * Based on export-recording/config.ts with adaptations for shared use.
 */
